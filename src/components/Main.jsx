...
const Main = () => {
  ...
  return (
    <div className=' bg-[#f7f7f7] sm:mb-0  ' > 
      <div className='flex flex-col md:flex-row justify-center items-start sm:mx-6 mt-10 md:mt-0  '>
        <div className=' w-full md:w-1/2  px-10   lg:px-16   '>
        ...
        <div className='w-screen md:w-1/2 flex-1 items-start  my-auto ' data-aos="fade-up"> 
          {/* <img className='w-auto md:w-[700px]  h-auto  md:my-0 mb-0' src='./mainImage.png' /> */}
          <img className='w-full md:w-[650px] mt-0 ' src='./frame2.png' />
        </div>
      </div>
    </div>
