    ...
    <div>
      <div className="flex flex-col md:flex-row items-center justify-center p-4 md:p-8 bg-white ">
        ...
        <div className="md:w-1/2 p-4 flex flex-col ">
          <h1
            className="text-3xl lg:text-5xl font-bold mb-4 font-[Poppins] text-customBlue text-center md:text-start"
            data-aos="fade-up"
          >
            The Value of Verifying Educational Credentials
          </h1>
          <p
            className="text-[15px] text-lg font-semibold mb-4 text-center md:text-start"
            data-aos="fade-up"
          >
          ...
          <div className="flex justify-start">
            <ul className=" mt-4">
              <li
                className="flex items-center  mb-2 text-lg font-bold font-[Rubik] font-regular text-gray-800   "
                data-aos="fade-up"
              >
                <img
                  src="/tickmark.png"
              ...
              <li
                className="flex items-center mb-2 text-lg font-bold  font-[Rubik] font-regular text-gray-700"
                data-aos="fade-up"
              >
                <img
                  src="/tickmark.png"
              ...
              <li
                className="flex items-center text-lg font-bold font-[Rubik] font-regular text-gray-700 "
                data-aos="fade-up"
              >
                <img
                  src="/tickmark.png"
      ...
      <div className="mt-8 bg-customBlue p-8  md:rounded-full rounded-3xl shadow-md max-w-md mx-auto lg:max-w-3xl ">
        <h2
          className="text-4xl font-[Poppins] font-bold text-white text-center"
          data-aos="fade-up"
        >
          All Educational Credentials, Verified and Consolidated
        </h2>
      </div>
      ...
      <div className="flex flex-col md:flex-row items-center   p-4 md:p-8 mt-8">
        <div className="md:w-3/5 p-4  ">
          <h2
            className="text-4xl md:text-5xl  font-bold mb-4 text-black md:text-left text-center"
            data-aos="fade-up"
          >
        ...
        <div className="md:w-2/5 p-4">
          ...
          <ul className="text-left mt-4">
            <li className="flex items-center mb-4" data-aos="fade-up">
              ...
              <div>
                <h3
                  className="text-customBlue font-bold drop-shadow-lg"
                  data-aos="fade-up"
                >
      ...
      <div className="flex flex-col md:flex-row items-center justify-center p-8 ">
        <div className="w-screen px-6 flex flex-col items-center">
          <h2
            className="text-3xl md:text-5xl font-bold font-[Poppins] md:mb-4 md:mx-10 text-customBlue text-center md:text-start"
            data-aos="fade-up"
          >
          ...
          <div className="h-auto grid grid-cols-1 md:grid-cols-2 gap-10 p-6">
            <div
              className="grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-10 my-10"
              data-aos="fade-up"
            >
              <div className="flex justify-center items-center border-b border-r shadow-blue-left-bottom border-black p-5">
                <img
                  ...
                  alt="Icon 1"
                />
                <span className="text-start md:text-center text-xl font-semibold">
                  Comprehensive <br /> Verification Solutions
                </span>
              </div>
              <div
            ...
            >
              <img
                src="/educationservice1.jpg"
                className="w-auto max-w-full md:max-w-[400px]"
                alt="Image"
              />
            </div>
          </div>
      ...
      >
        <div className="flex items-center ">
          ...
          <h2
            className="text-5xl font-[Rubik] font-semibold   text-customBlue text-center"
            data-aos="fade-up"
          >
      ...
      <div>
        <div
          className="flex flex-col items-center justify-center mt-8 lg:flex-row lg:items-center"
          data-aos="fade-up"
        >
          <img
            src="/ss.png"
          ...
          />
          <h1
            className="text-2xl md:text-4xl text-center font-[Rubik] mx-20 py-10 text"
            data-aos="fade-up"
          >
            "Redefining assurance through comprehensive verification practices,
